...
<footer>
    <div class="container">
        <div class="top">
            <div class="top_left">
                <img src="{{storage(setting('site_color_logo'))}}">
            </div>
        ...
        <div class="middle">
            <div class="middle_first">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p>
                            <a href="mail:{{setting('footer_email')}}">
            ...
            <div class="middle_third">
                ...
                <p><a href="{{route('property.index')}}">Özellikler</a></p>
                <p><a href="{{route('package.index')}}">Fiyatlar</a></p>
                <p><a href="{{route('partnership.index')}}">İş Ortaklığı</a></p>
                <p><a href="{{route('blog.index')}}">Bloglar</a></p>
            </div>
            <div class="middle_fourth">
                ...
                <p><a href="{{route('page.detail', 'hakkimizda')}}">Hakkımızda</a></p>
        ...
        <div class="end">
            ...
            <div>
                <svg class="end_icons" onclick="window.open('{{setting('social_facebook')}}', '_blank')" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewbox="0 0 16 16">
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z">
                    </path>
                </svg>
                <svg class="end_icons" onclick="window.open('{{setting('social_twitter')}}', '_blank')" xmlns="http://www.w3.org/2000/svg" role="img" viewbox="0 0 24 24" fill="currentColor">
                    <title>X</title>
                    <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z">
                    </path>
                </svg>
                <svg class="end_icons" onclick="window.open('{{setting('social_instagram')}}', '_blank')" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewbox="0 0 16 16">
