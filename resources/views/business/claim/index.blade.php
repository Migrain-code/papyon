                ...
                <div class="card my-4">
                    ...
                    <div class="card-body order-0 order-md-1">
                        ...
                        <ul class="nav nav-pills flex-column flex-md-row mb-4 mt-4 ms-2">
                            <li class="nav-item">
                                <a class="nav-link @if(request()->routeIs('business.claim.index')) active @endif" href="{{route('business.claim.index')}}">
                                    <i class="ti ti-shopping-cart ti-xs me-1"></i>
                                    Siparişler
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(request()->routeIs('business.claim.index'))  @endif" href="{{route('business.claim.index')}}">
