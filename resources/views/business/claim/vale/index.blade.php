                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-7">
                            <div class="card-body text-nowrap">
                                ...
                                <a href="{{route('business.claim.vale')}}" class="btn btn-primary">Vale Talepleri</a>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">
                                    <h4 >Vale Talepleri</h4>
                                </div>
                                <x-table-all-delete-button title="Vale Taleplerini" model="App\Models\Claim"></x-table-all-delete-button>
                            </div>
...
@section('scripts')
    ...
    <script>
        var DATA_URL = "{{route('business.claim.datatable')}}?typeId=1";
        var DATA_COLUMNS = [
            {data: 'id'},
            {data: 'name'},
            {data: 'status'},
