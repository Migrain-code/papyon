...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light"> </span>Sözleşmeler</h4>
        <div class="row">
            <!-- View sales -->
            <div class="col-12">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-7">
                            <div class="card-body text-nowrap">
                                <h5 class="card-title mb-0">Sözleşmeler! 🎉</h5>
...
@section('scripts')
    <script>
        var DATA_URL = "{{route('business.contract.datatable')}}";
        var DATA_COLUMNS = [
            {data: 'id'},
            {data: 'title'},
            {data: 'description'},
