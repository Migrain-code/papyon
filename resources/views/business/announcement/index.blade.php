...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light"> </span>Duyurular</h4>
        <div class="row">
            <!-- View sales -->
            <div class="col-12">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-7">
                            <div class="card-body text-nowrap">
                                <h5 class="card-title mb-0">Duyurular! 🎉</h5>
                                <p class="mb-2">Tüm Duyurularınızın işlemlerini bu alanda yapabilirsiniz</p>
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-3">
                                    <x-table-all-delete-button title="Seçilen Duyuruları" model="App\Models\Announcement"></x-table-all-delete-button>
                                    <button class="btn btn-primary" data-bs-target="#addAdvertModal" data-bs-toggle="modal">Duyuru Oluştur</button>
                                </div>
    ...
    @include('business.announcement.modals.add-advert')
@endsection
@section('scripts')
    <script>
        var DATA_URL = "{{route('business.announcement.datatable')}}";
        var DATA_COLUMNS = [
            {data: 'id'},
            {data: 'title'},
            {data: 'description'},
