...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light"> </span>Masa Şablonları</h4>
        <div class="row">
            <!-- View sales -->
            <div class="col-12">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-7">
                            <div class="card-body text-nowrap">
                                <h5 class="card-title mb-0">Masa Şablonları! 🎉</h5>
                                <p class="mb-2">Tüm Masa Şablonları işlemlerini bu alanda yapabilirsiniz</p>
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title">
                                    <h4 >Masa Şablonları</h4>
                                </div>
                                <div class="d-flex gap-3">
                                    <x-table-all-delete-button title="Seçilen Masa Şablonlarını" model="App\Models\PlaceTemplate"></x-table-all-delete-button>
                                    <a class="btn btn-primary" href="{{route('business.placeTemplate.create')}}">Tümünü İndir</a>
                                </div>
...
@section('scripts')
    <script>
        var DATA_URL = "{{route('business.placeTemplate.datatable')}}";
        var DATA_COLUMNS = [
            {data: 'id'},
            {data: 'table_name'},
            {data: 'image'},
