...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-2"><span class="text-muted fw-light"> </span>Alerjen Düzenle</h4>
        <div class="row">
            <!-- View sales -->
            <div class="col-12">
                ...
                <div class="card">
                   <div class="card-body">
                       <!-- User Content -->
                       <form id="editUserForm" class="row g-3" method="post" action="{{route('admin.allergen.update', $allergen->id)}}" enctype="multipart/form-data">
                           @csrf
                           @method('PUT')
                           ...
                           <div class="col-12 mt-2">
                               <label class="form-label" for="addProductQuantity">Icon <a href="{{storage($allergen->icon)}}" target=_blank>Görüntüle</a></label>
                               <input
                                   type="file"
                                   id="addProductQuantity"
                                   name="icon"
