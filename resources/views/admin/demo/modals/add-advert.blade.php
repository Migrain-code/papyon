    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <form id="editUserForm" class="row g-3" method="post" action="{{route('admin.demoRequest.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-6 mt-2">
                        <input class="form-control" name="company_name" value="{{old('subject')}}" placeholder="Şirket adı" type="text">
                    </div>
