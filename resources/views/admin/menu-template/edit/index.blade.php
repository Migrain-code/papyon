        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                   <div class="card-body">
                       <!-- User Content -->
                       <form id="editUserForm" class="row g-3" method="post" action="{{route('admin.menu-template.update', $menuTemplate->id)}}" enctype="multipart/form-data">
                           @csrf
                           @method('PUT')
                           ...
                           <div class="col-12 mt-2">
                               <label class="form-label" for="addProductQuantity">Tema Görseli (356 * 903) <a href="{{storage($menuTemplate->image)}}" target="_blank">Göster</a></label>
                               <input
                                   type="file"
                                   id="addProductQuantity"
                                   name="image"
