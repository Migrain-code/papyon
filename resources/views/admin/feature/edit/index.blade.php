...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-2"><span class="text-muted fw-light"> </span>Özellik Düzenle</h4>
        <div class="row">
            <!-- View sales -->
            <div class="col-12">
                ...
                <div class="card">
                   <div class="card-body">
                       <!-- User Content -->
                       <form id="editUserForm" class="row g-3" method="post" action="{{route('admin.feature.update', $feature->id)}}" enctype="multipart/form-data">
                           @csrf
                           @method('PUT')
                           ...
                           <div class="col-12 mt-2">
                               ...
                               <textarea
                                   ...
                                   class="form-control"
                                   rows="5"
                               >{{$feature->meta_description}}</textarea>
                           </div>
                           <div class="col-12 mt-2">
                               <label class="form-label" for="addProductQuantity">Açıklama</label>
                               <div id="full-editor">{!! $feature->description !!}</div>
                               <input type="hidden" value="{{$feature->description }}" name="blog_content" id="editorContent">
                           </div>
