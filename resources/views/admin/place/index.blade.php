            ...
            <div class="card mb-4">
                <div class="card-header d-flex flex-wrap justify-content-between gap-3">
                    ...
                    <form class="d-flex align-items-center gap-2" method="get" action="">
                            <input type="search" name="placeName" class="form-control" placeholder="Mekan Adını Giriniz">
                            <button type="submit" class="btn btn-icon btn-primary"><i class="ti ti-search"></i></button>
                    </form>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="card p-2 h-100 shadow-none border">
                                    <div class="card-body p-3 pt-2">
                                        ...
                                        <a href="{{route('admin.place.edit', $place->id)}}" class="h5">{{$place->name}}</a>
                                        ...
                                        <div class="d-flex flex-column flex-md-row gap-2 text-nowrap">
                                            @if($place->status == 2)
                                                <a
                                                    ...
                                                    href="{{route('admin.place.active', $place->id)}}">
                                            ...
                                            @else
                                                <a
                                                    ...
                                                    href="{{route('admin.place.passive', $place->id)}}">
                                                    <i class="ti ti-rotate-clockwise-2 align-middle scaleX-n1-rtl me-2 mt-n1 ti-sm"></i
                                                    ><span>Pasife Al</span>
                                                </a>
                                            @endif
                            ...
                            <div class="alert alert-primary alert-dismissible text-center d-flex flex-column align-items-center " role="alert">
                                ...
                                <p class="my-3" style="max-width: 400px">
                                    @if(isset(request()->placeName))
                                       Aradığınız Mekan Adı ile Mekan bulunamadı
                                    @else
