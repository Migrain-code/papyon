        ...
        <div class="row">
            ...
            <div class="col-12">
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-7">
                            <div class="card-body text-nowrap">
                                ...
                                <a href="{{route('admin.place.index')}}" class="btn btn-primary">Mekan Listesi</a>
                            </div>
                        </div>
                ...
                <div class="card my-4">
                    ...
                    <form class="card-body" method="post" action="{{route('admin.place.update', $place->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        @include('admin.place.edit.steps.step-1')
                        @include('admin.place.edit.steps.step-2')
                        @include('admin.place.edit.steps.step-3')
                        @include('admin.place.edit.steps.step-4')
                        @include('admin.place.edit.steps.step-5')
                        @include('admin.place.edit.steps.step-6')
                        @include('admin.place.edit.steps.step-7')
