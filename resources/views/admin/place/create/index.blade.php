        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card my-4">
                    ...
                    <form class="card-body" method="post" action="{{route('admin.place.store')}}" enctype="multipart/form-data">
                        @csrf
                        @include('admin.place.create.steps.step-1')
                        @include('admin.place.create.steps.step-2')
                        @include('admin.place.create.steps.step-3')
                        @include('admin.place.create.steps.step-4')
                        @include('admin.place.create.steps.step-5')
                        @include('admin.place.create.steps.step-6')
                        @include('admin.place.create.steps.step-7')
