    ...
    <div class="row p-3">
        <div class="col-2 mb-md-0 mb-2">
            <div class="form-check custom-option custom-option-image custom-option-image-check">
                <input class="form-check-input" name="theme_id" type="radio" value="1" id="customCheckboxImg1" checked />
        ...
        <div class="col-2 mb-md-0 mb-2">
            <div class="form-check custom-option custom-option-image custom-option-image-check">
                <input class="form-check-input" name="theme_id" type="radio" value="2" id="customCheckboxImg2" />
        ...
        <div class="col-2">
            <div class="form-check custom-option custom-option-image custom-option-image-check">
                <input class="form-check-input" name="theme_id" type="radio" value="3" id="customCheckboxImg3" />
        ...
        <div class="col-2">
            <div class="form-check custom-option custom-option-image custom-option-image-check">
                <input class="form-check-input" name="theme_id" type="radio" value="4" id="customCheckboxImg3" />
                <label class="form-check-label custom-option-content" for="customCheckboxImg3">
                                              <span class="custom-option-body">
                                                <img src="/business/assets/img/themes/menu1.jpg" alt="cbImg" />
                                              </span>
