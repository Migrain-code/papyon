...
@section('title', 'Entegrasyon Düzenle')
@section('styles')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-2"><span class="text-muted fw-light"> </span>Entegrasyon Düzenle</h4>
        <div class="row">
            <!-- View sales -->
            <div class="col-12">
                ...
                <div class="card">
                   <div class="card-body">
                       <!-- User Content -->
                       <form id="editUserForm" class="row g-3" method="post" action="{{route('admin.entegration.update', $entegration->id)}}" enctype="multipart/form-data">
                           @csrf
                           @method('PUT')
                           ...
                           <div class="col-12 mt-2">
                               <label class="form-label" for="addProductQuantity">Link</label>
                               <input
                                   type="text"
                                   id="addProductQuantity"
                                   name="link"
                                   value="{{$entegration->link}}"
                                   class="form-control"

                               />
                           </div>
                           <div class="col-12 mt-2">
                               <label class="form-label" for="addProductQuantity">Görsel <a href="{{storage($entegration->image)}}" target="_blank">Göster</a></label>
                               <input
                                   type="file"
                                   id="addProductQuantity"
                                   name="image"
