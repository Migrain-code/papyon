                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button @if($loop->index > 0) collapsed  @endif" data-bs-toggle="collapse"
                                ...
                                <img src="{{storage($category->image)}}" style="@if(!isset($category->sub_title)) max-width:50px @else max-width:60px @endif"  />
                                <div class="column">
                                    <span>
                                       {{$category->name}}
                                    </span>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="col">
                                                        <div class="d-flex text-end justify-content-end flex-column">
                                                            <div class="col">
                                                                @if($addToCartButton)
                                                                    <button type="button" class="addToCardButton" @if(in_array($product->id, $cartProducts)) style="transform: rotate(135deg);color: red" @endif  data-product="{{$product->id}}">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if(response.status == "success"){
                        ...
                        $('.cart').text(response.carts.length);
                    } else{
